...
python main.py  --dataset pre_processed_mnist --model ConvNet  --ipc 1 --Iteration 1000 --domain-adaptation True --dsa_strategy None --data_path /home/daniel/exjobb/Transfer-Learning-Library/examples/domain_adaptation/image_classification/data/pre_cond/digits